...
contract NFTAuctionV1Test is Test {
    ...
    NFTAuctionV1 public auction;

    NFTAuctionV1 public impl;

    ERC1967Proxy public proxy;

    NFTAuctionV1 public wrappedProxy;
    ...
    function setUp() public {
        impl = new NFTAuctionV1();
        bytes memory initData = abi.encodeCall(NFTAuctionV1.initialize, (admin));

        TransparentUpgradeableProxy proxyUpgrade = new TransparentUpgradeableProxy(address(impl), proxyAdmin, initData);

        auction = NFTAuctionV1(address(proxyUpgrade));
    ...
    function test_GetVersion() public {
        assertEq(auction.getVersion(), "V1");
    }
